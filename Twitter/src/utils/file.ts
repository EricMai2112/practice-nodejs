...
export const handleUploadImage = async (req: Request) => {
  ...
  const form = formidable({
    uploadDir: UPLOAD_IMAGE_TEMP_DIR, // Lưu ảnh ở file uploads, nếu không tạo thì upload thành công nhưng không nhảy vào đâu hết, nên phải kiểm tra và tạo
    maxFiles: 4,
    keepExtensions: true, //Hiện đuôi file mở rộng
    maxFileSize: 400 * 1024, // 400KB / 1 file
