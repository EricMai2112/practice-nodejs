...
const imageSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.IMAGE_LENGTH_MUST_BE_1_TO_200
  }
}
  ...
  checkSchema(
    {
      ...
      bio: {
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.BIO_LENGTH_MUST_BE_1_TO_200
        }
      },
      location: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.LOCATION_LENGTH_MUST_BE_1_TO_200
        }
      },
      website: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.WEBSITE_LENGTH_MUST_BE_1_TO_200
        }
      },
      username: {
        optional: true,
        ...
        custom: {
          options: async (value, { req }) => {
            ...
            //If existed username, not allow to update this username
            if (user) {
...
export const changePaswordValidator = validate(
  checkSchema(
    {
      old_password: {
        ...passwordSchema,
        custom: {
          options: async (value: string, { req }) => {
            ...
            if (!user) {
              throw new ErrorWithStatus({
                message: USERS_MESSAGES.USER_NOT_FOUND,
                status: httpStatus.USER_NOT_FOUND
              })
            }
