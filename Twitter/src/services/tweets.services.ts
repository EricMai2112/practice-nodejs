...
class TweetService {
  ...
  async getTweetChildren({
    ...
    //Vì khi chạy xong nó không gọi lại, chỉ thay đổi trong database nên ta phải dùng forEach dưới để trả về cho người dùng kết quả đúng
